...
import PhysicsGame, {ObjectPhysicsInfo, CollisionCube, CollisionActionType, MoveDirType, CollisionCustom} from "../physicsGame"
import { Cube, Custom, getShape } from "./_shape"

export function checkCubeToCustom(objPhysInfo1: ObjectPhysicsInfo, objPhysInfo2: ObjectPhysicsInfo, physicsGame: PhysicsGame): boolean {
    let res = false
    res = res || _checkCubeToCustom(objPhysInfo1, objPhysInfo2, physicsGame)
    res = res || _checkCubeToCustom(objPhysInfo2, objPhysInfo1, physicsGame)
    return res
}

function _checkCubeToCustom(objPhysInfo1: ObjectPhysicsInfo, objPhysInfo2: ObjectPhysicsInfo, physicsGame: PhysicsGame): boolean {
...
export function actionBetweenCubeToCustom(actionType: CollisionActionType, objPhysInfo1: ObjectPhysicsInfo, objPhysInfo2: ObjectPhysicsInfo, moveDir: MoveDirType, physicsGame: PhysicsGame) {
    _actionBetweenCubeToCustom(actionType, objPhysInfo1, objPhysInfo2, moveDir, physicsGame)
    _actionBetweenCubeToCustom(actionType, objPhysInfo2, objPhysInfo1, moveDir, physicsGame)
}

function _actionBetweenCubeToCustom(actionType: CollisionActionType, objPhysInfo1: ObjectPhysicsInfo, objPhysInfo2: ObjectPhysicsInfo, moveDir: MoveDirType, physicsGame: PhysicsGame) {
